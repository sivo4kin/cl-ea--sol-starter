...
const ENSResolverABI = "[{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"node\",\"type\":\"bytes32\"}],\"name\":\"addr\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]"
...
func NewENSResolverSession(address common.Address, backend bind.ContractBackend, transactionSession *bind.TransactSession) (*ENSResolverSession, error) {
	ENSResolverInstance, err := NewENSResolver(address, backend)
	if err != nil {
		return nil, err
	}
	return &ENSResolverSession{
		Contract:           ENSResolverInstance,
...
func (_ENSResolver *ENSResolverSession) Addr(node [32]byte) (common.Address, error) {
	return _ENSResolver.Contract.Addr(_ENSResolver.transactionSession.CallOpts, node)
}
